...
@Component({
    selector: 'masterDetailChild_Order_viewOrderItemModal',
    templateUrl: './masterDetailChild_Order_view-orderItem-modal.component.html'
})
export class MasterDetailChild_Order_ViewOrderItemModalComponent extends AppComponentBase {
